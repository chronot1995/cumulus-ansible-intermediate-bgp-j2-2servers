## cumulus-ansible-intermediate-bgp-j2-2servers
...
![Network Diagram](https://github.com/chronot1995/cumulus-ansible-intermediate-bgp-j2-2servers/blob/master/documentation/cumulus-ansible-intermediate-bgp-j2-2servers.png)
...
```
    git clone https://github.com/chronot1995/cumulus-ansible-intermediate-bgp-j2-2servers/
```
...
```
    cumulus-ansible-intermediate-bgp-j2-2servers/automation
```
...
```
     ./topology_converter.py cumulus-ansible-intermediate-bgp-j2-2servers.dot -c --provider=virtualbox
     ./topology_converter.py cumulus-ansible-intermediate-bgp-j2-2servers.dot -c --provider=libvirt
```
