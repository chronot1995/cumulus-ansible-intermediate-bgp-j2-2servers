...
#    using topology data from: cumulus-ansible-intermediate-bgp-j2-2servers.dot
...
REPOSITORY="https://github.com/CumulusNetworks/cumulus-ansible-intermediate-bgp-j2-2servers"
REPONAME="cumulus-ansible-intermediate-bgp-j2-2servers"
